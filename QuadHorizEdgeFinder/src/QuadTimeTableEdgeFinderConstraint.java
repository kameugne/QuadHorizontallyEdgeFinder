...
public class QuadTimeTableEdgeFinderConstraint extends AdjustmentsPropagator {
    ...
    public QuadTimeTableEdgeFinderConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        do
        {
            ...
            QuadTimeTableEdgeFinder ef = new QuadTimeTableEdgeFinder(tasks, capacity);
            QuadTimeTableEdgeFinder ef_negative = new QuadTimeTableEdgeFinder(negativeTasks, capacity);

            //int[] estprime = ef.EdgeFinder_Detection_Pruning();
            //int[] estprime_negative = ef_negative.EdgeFinder_Detection_Pruning();
